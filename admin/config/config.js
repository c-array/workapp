...
db.workDepartment = db.sequelize.import('../models/work_department.js'); //部门模型
db.workMenu = db.sequelize.import('../models/work_menu.js'); //菜单模型
db.workProductProject = db.sequelize.import('../models/work_product_project.js'); //产品项目模型
db.workRole = db.sequelize.import('../models/work_role.js'); //角色模型
db.workRoleMenu = db.sequelize.import('../models/work_role_menu.js'); //角色用户模型
db.workSubtask = db.sequelize.import('../models/work_subtask.js'); //子任务模型
db.workWeekly = db.sequelize.import('../models/work_weekly.js'); //周任务模型
